...
class TestDrive {
    public static void main(String[] args) throws InterruptedException {
        ...
        instantWithDecor = new Whip(/* write your code here */ instantWithDecor);
        instantWithDecor = new Sugar(/* write your code here */ instantWithDecor);
        instantWithDecor = new Sugar(/* write your code here */ instantWithDecor);
        instantWithDecor = new Sugar(/* write your code here */ instantWithDecor);
        System.out.println(instantWithDecor.getDescription() + " $" + formatSum(/* write your code here */instantWithDecor.cost()));
        ...
        System.out.println(/* write your code here */instantWithDecor.getDescription() + " $" + formatSum(/* write your code here */instantWithDecor.cost()));
    }
